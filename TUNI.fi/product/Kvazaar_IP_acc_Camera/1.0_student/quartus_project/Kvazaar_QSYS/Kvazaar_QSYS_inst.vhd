	component Kvazaar_QSYS is
		port (
			...
			axi_to_channel_0_channel_vz                 : in    std_logic                     := 'X';             -- vz
			axi_to_channel_0_channel_data               : out   std_logic_vector(31 downto 0);                    -- data
			axi_to_channel_0_channel_lz                 : out   std_logic;                                        -- lz
	...
	u0 : component Kvazaar_QSYS
		port map (
			...
			axi_to_channel_0_channel_vz                 => CONNECTED_TO_axi_to_channel_0_channel_vz,                 --             axi_to_channel_0_channel.vz
			axi_to_channel_0_channel_data               => CONNECTED_TO_axi_to_channel_0_channel_data,               --                                     .data
			axi_to_channel_0_channel_lz                 => CONNECTED_TO_axi_to_channel_0_channel_lz,                 --                                     .lz
